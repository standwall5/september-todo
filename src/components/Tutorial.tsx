...
const tutorialSteps: TutorialStep[] = [
  {
    ...
    content: "Let's take a quick tour of your new productivity workspace! This tutorial will show you all the amazing features available.",
    position: "center",
    action: "none"
  },
  {
    ...
    content: "This is your taskbar - your central hub for all applications. Notice the pixelated retro design that makes productivity fun!",
  ...
  },
  {
    ...
    content: "This is your September start button. While it looks familiar, it represents your personalized workspace identity.",
  ...
  },
  {
    ...
    content: "Click here to create and manage your todos. Features include categories, priorities, due dates, and progress tracking.",
  ...
  },
  {
    ...
    content: "Your calendar helps you schedule events, set reminders, and visualize your time. Perfect for planning ahead!",
  ...
  },
  {
    ...
    content: "Capture thoughts, ideas, and important information. Organize notes in folders and keep everything searchable.",
  ...
  },
  {
    ...
    content: "Organize your web browsing! Save bookmark groups, manage tabs, and quick-launch your favorite sites.",
  ...
  },
  {
    ...
    title: "⏱️ Focus Timer",
    content: "Stay productive with the Pomodoro technique! Set focus sessions, take breaks, and track your concentration.",
  ...
  },
  {
    ...
    content: "Export and import all your data securely with encryption. Your privacy is protected with local-only storage.",
  ...
  },
  {
    ...
    content: "Did you know? You can drag and drop these icons to rearrange them! Try dragging any icon anywhere on the screen - it will magnetically snap to position!",
    targetSelector: ".app-launchers",
    position: "top",
    highlight: true
  },
  {
    ...
    content: "Control your experience with background music and sound effects. Toggle them on/off as you prefer.",
  ...
  },
  {
    ...
    content: "Keep track of time and date. Your productivity workspace keeps you informed at a glance.",
  ...
  },
  {
    ...
    content: "Need help anytime? Click the wizard icon to restart this tutorial or get assistance with any feature.",
  ...
  },
  {
    ...
    content: "Congratulations! You've completed the September tour. Your data is automatically saved locally, and you can always access this tutorial again. Start being productive!",
    position: "center",
    action: "none"
  }
];

export const Tutorial: React.FC<TutorialProps> = ({ isVisible, onClose, onComplete }) => {
  ...
  const removeHighlight = () => {
    ...
    document.querySelectorAll(".tutorial-highlight, .tutorial-spotlight").forEach(el => {
  ...
  return (
    <>
      ...
      <div 
        ref={overlayRef}
        className={`tutorial-overlay ${isHighlighting ? "tutorial-spotlighting" : ""}`}
